...
<div class="form" id="form-main">
    <div id="form-div">
        ...
        ${mailNotExist}
        <%--<div id="mail-not-exist"><ul><li>L'adresse mail n'existe pas</li></ul></div>--%>
        ...
        <form action="${pageContext.request.contextPath}/login/changePwd" method="post">
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input class="validate " id="email-forgot" type="email" required autocomplete="off">
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input id="password-forgot" type="password" class="validate"  required autocomplete="off">
                </div>
            </div>
