...
public class EventDAOTest {
    ...
    public void testGetPageEvents() {
        ...
        assertEquals(eventsThirdPage.get(3).getId(), new Integer(17));

        assertEquals(eventsFourthPage.size(), 3);
        assertEquals(eventsFourthPage.get(0).getId(), new Integer(18));
        assertEquals(eventsFourthPage.get(2).getId(), new Integer(20));
